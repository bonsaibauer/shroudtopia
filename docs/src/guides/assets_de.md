...
Ownership vollständiger Dokumente und überlappende Parent-/Child-Felder kollidieren mit anderem Owner und liefern `RESULT_CONFLICT`. `save` bestätigt die Dateipublikation, nicht das Live-Reload bereits vom Spiel gehaltener Ressourcen. Siehe vollständige [Asset API](../reference/api.md).
