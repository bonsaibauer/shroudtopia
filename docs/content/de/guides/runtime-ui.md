...
Runtime Patches benötigen `shroudtopia.runtime.patches`. Signaturen gegen jedes unterstützte Game-Profil validieren und genau einen Treffer im ausführbaren Bereich fordern. `overwrite_size` muss vollständige Instruktionen abdecken. Den Patch inaktiv erstellen, bei Bedarf aktivieren und zum Wiederherstellen der Originalbytes freigeben.
