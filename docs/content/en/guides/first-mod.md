...
Create a Windows x64 DLL, add `api` to the include path, include `shroudtopia.h`, and export `CreateMod`.
...
Start the game, find the owner-tagged message in `shroudtopia.log`, and fix any loader error before adding services. Continue with [ownership](../concepts/ownership.md) and the [API](../reference/api.md).
