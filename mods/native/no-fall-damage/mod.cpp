...
namespace {
constexpr char ModId[] = "mod.no-fall-damage";
constexpr char Label[] = "No Fall Damage";
constexpr uint8_t Payload[] = {0x45,0x01,0x0C,0x88,0x48,0x8B,0xCB,0xE9,0,0,0,0};
...
ST_Result ST_CALL Load(const ST_HostApiV1* host, void*) {
    ...
    const ST_RuntimeRelocationV1 returnJump{
        sizeof(ST_RuntimeRelocationV1), 8, ST_RUNTIME_RELOCATION_REL32_RETURN
    };
    const ST_RuntimePatchDescriptorV1 descriptor{
        sizeof(ST_RuntimePatchDescriptorV1), View("45 89 0C 88 48 8B CB"), 0,
